 ...
 */
#define TXT_MNM_PTR_PULL               NSLocalizedStringFromTable(@"Pulldown to refrsh",MNM_PTR_LOCALIZED_STRINGS_TABLE, nil)

#define TXT_MNM_PTR_LOADING                                             NSLocalizedStringFromTable(@"Loading...", MNM_PTR_LOCALIZED_STRINGS_TABLE, nil)
...
- (void)changeStateOfControl:(MNMPullToRefreshViewState)state withOffset:(CGFloat)offset {
    ...
    switch (state_) {
        ...
        case MNMPullToRefreshViewStateIdle: {
            ...
            [topLabel_ setText:[NSString stringWithFormat:@"Last updated on: %@", [dateFormatter_ stringFromDate:lastUpdateDate_]]];
